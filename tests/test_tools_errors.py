...
from src.tools.dbir_rag_tool import dbir_rag_tool # Importar la instancia de la herramienta
...
@patch('stix2.datastore.taxii.TAXIICollectionSource') # Mockear la clase que hace la llamada de red
